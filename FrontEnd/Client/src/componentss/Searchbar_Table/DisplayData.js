...
const DisplayData = () => {
  ...
  //React website to collect information about how visitors use the website and to 
  //collect standard analytics to gather data to enhance the performance of our website.
  ...
  const onSearch = (searchTerm) => {
    ...
    axios({
      method: "get",
      url: "https://localhost:5000/property",
      headers: {
  ...
  useEffect(() => {
    const afterLogin = () => {
      console.log("Inside afterLogin function DisplayData.js useEffect");
      axios({
        method: "get",
        url: "https://localhost:5000/property",
        headers: {
        ...
        .then((res) => {
          console.log("Inside then block of DisplayData.js");
          setUsers(res.data.property);
        })
        .catch((err) => {
          console.log("Inside catch block of DisplayData.js");
          console.log(err);
